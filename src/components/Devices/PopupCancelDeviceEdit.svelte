<script lang="ts">
    ...
    // Styles
    import { SubDefaultButtonStyle } from "$lib/style/button";

    // Props
    export let windowOpened: boolean;

    // Export Cancel Edit Function
    export let onCancelEdit: () => void | Promise<void>;
            ...
            <div class="window-div">
                ...
                >
                    <div class="modal-window-div">
                        <span>{$texts.cancelDeviceEditInfo}</span>
                        <div class="button-div">
                            <Button buttonText={$texts.confirm} style={$SubDefaultButtonStyle} onClick={handleCancelEdit} />
                        </div>
                    </div>
                </ModalWindow>
            </div>
