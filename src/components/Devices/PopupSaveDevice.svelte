<script lang="ts">
    ...
    // Styles
    import { SubPrimaryButtonStyle } from "$lib/style/button";
                ...
                >
                    <div class="modal-window-div">
                        ...
                        <div class="button-div save-window-button">
                            <Button processing={processingRequest} buttonText={$texts.confirm} style={$SubPrimaryButtonStyle} onClick={handleSave} />
                        </div>
                    </div>
                </ModalWindow>
            </div>
