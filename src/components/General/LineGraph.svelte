<script lang="ts">
    ...
    //Props
    export let data: Array<Record<number, number>>;
    export let dataLabel: Array<string>;
    export let dataColors: Array<string>;
    ...
    // Plot (inner drawing area) background separate from outer container
    export let plotBackgroundColor: string | undefined = "rgba(0,0,0,0)"; // transparent by default
    ...
    // Functions
    function convertDataForUplot(data: Array<Record<number, number>>): uPlot.AlignedData {
